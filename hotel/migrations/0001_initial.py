    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('3AC', 'Full three bedroom apartment with air conditioning'), ('YAC', 'double room with air conditioning'), ('ONE', 'Design apartment of a room with air conditioning'), ('TWO', 'Full two bedroom apartment without air conditioning'), ('NAC', 'Double bedroom without air conditioning')], max_length=3)),
